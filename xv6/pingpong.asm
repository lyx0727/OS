...
main()
{
  ...
  12:	51                   	push   %ecx
    int p_son[2], p_par[2];
    pipe(p_son);
  13:	8d 45 e8             	lea    -0x18(%ebp),%eax
{
  16:	83 ec 2c             	sub    $0x2c,%esp
    pipe(p_son);
  19:	50                   	push   %eax
  1a:	e8 54 03 00 00       	call   373 <pipe>
    pipe(p_par);
  1f:	8d 45 f0             	lea    -0x10(%ebp),%eax
  22:	89 04 24             	mov    %eax,(%esp)
  25:	e8 49 03 00 00       	call   373 <pipe>
    if(fork() == 0){
  2a:	e8 2c 03 00 00       	call   35b <fork>
  2f:	83 c4 10             	add    $0x10,%esp
  32:	85 c0                	test   %eax,%eax
  34:	75 62                	jne    98 <main+0x98>
        close(p_par[1]);
  36:	83 ec 0c             	sub    $0xc,%esp
  39:	ff 75 f4             	pushl  -0xc(%ebp)
  3c:	e8 4a 03 00 00       	call   38b <close>
        close(p_son[0]);
  41:	5b                   	pop    %ebx
  42:	ff 75 e8             	pushl  -0x18(%ebp)
        char buf[2];
        read(p_par[0], buf, 1);
  45:	8d 5d e6             	lea    -0x1a(%ebp),%ebx
        close(p_son[0]);
  48:	e8 3e 03 00 00       	call   38b <close>
        read(p_par[0], buf, 1);
  4d:	83 c4 0c             	add    $0xc,%esp
  50:	6a 01                	push   $0x1
  52:	53                   	push   %ebx
  53:	ff 75 f0             	pushl  -0x10(%ebp)
  56:	e8 20 03 00 00       	call   37b <read>
        close(p_par[0]);
  5b:	58                   	pop    %eax
  5c:	ff 75 f0             	pushl  -0x10(%ebp)
  5f:	e8 27 03 00 00       	call   38b <close>
        printf(1, "%d: received ping\n",getpid());
  64:	e8 7a 03 00 00       	call   3e3 <getpid>
  69:	83 c4 0c             	add    $0xc,%esp
  6c:	50                   	push   %eax
  6d:	68 28 08 00 00       	push   $0x828
  72:	6a 01                	push   $0x1
  ...
  82:	e8 fc 02 00 00       	call   383 <write>
        close(p_son[1]);
  87:	58                   	pop    %eax
  88:	ff 75 ec             	pushl  -0x14(%ebp)
  8b:	e8 fb 02 00 00       	call   38b <close>
  90:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  93:	e8 cb 02 00 00       	call   363 <exit>
        close(p_son[1]);
  98:	83 ec 0c             	sub    $0xc,%esp
  9b:	ff 75 ec             	pushl  -0x14(%ebp)
  9e:	e8 e8 02 00 00       	call   38b <close>
        close(p_par[0]);
  a3:	58                   	pop    %eax
  a4:	ff 75 f0             	pushl  -0x10(%ebp)
  a7:	e8 df 02 00 00       	call   38b <close>
        write(p_par[1], "@", 2);
  ac:	83 c4 0c             	add    $0xc,%esp
  af:	6a 02                	push   $0x2
  b1:	68 3b 08 00 00       	push   $0x83b
  b6:	ff 75 f4             	pushl  -0xc(%ebp)
  b9:	e8 c5 02 00 00       	call   383 <write>
        close(p_par[1]);
  be:	5a                   	pop    %edx
  bf:	ff 75 f4             	pushl  -0xc(%ebp)
  c2:	e8 c4 02 00 00       	call   38b <close>
        read(p_son[0], buf, 1);
  c7:	83 c4 0c             	add    $0xc,%esp
  ca:	8d 45 e6             	lea    -0x1a(%ebp),%eax
  cd:	6a 01                	push   $0x1
  cf:	50                   	push   %eax
  d0:	ff 75 e8             	pushl  -0x18(%ebp)
  d3:	e8 a3 02 00 00       	call   37b <read>
        close(p_son[0]);
  d8:	59                   	pop    %ecx
  d9:	ff 75 e8             	pushl  -0x18(%ebp)
  dc:	e8 aa 02 00 00       	call   38b <close>
        printf(1, "%d: received pong\n",getpid());
  e1:	e8 fd 02 00 00       	call   3e3 <getpid>
  e6:	83 c4 0c             	add    $0xc,%esp
  e9:	50                   	push   %eax
  ea:	68 3d 08 00 00       	push   $0x83d
  ef:	6a 01                	push   $0x1
  f1:	e8 ca 03 00 00       	call   4c0 <printf>
  f6:	83 c4 10             	add    $0x10,%esp
  f9:	eb 98                	jmp    93 <main+0x93>
  fb:	66 90                	xchg   %ax,%ax
  fd:	66 90                	xchg   %ax,%ax
  ff:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 50 08 00 00       	mov    $0x850,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 695:	a1 04 0b 00 00       	mov    0xb04,%eax
{
 ...
 6b6:	73 10                	jae    6c8 <free+0x38>
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	a3 04 0b 00 00       	mov    %eax,0xb04
}
 6e7:	5e                   	pop    %esi
 6e8:	5f                   	pop    %edi
 6e9:	5d                   	pop    %ebp
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70a:	a3 04 0b 00 00       	mov    %eax,0xb04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 72d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 730:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 779:	8b 3d 04 0b 00 00    	mov    0xb04,%edi
 ...
 7a2:	e8 e9 fe ff ff       	call   690 <free>
  return freep;
 7a7:	a1 04 0b 00 00       	mov    0xb04,%eax
 ...
 7d4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7d7:	a3 04 0b 00 00       	mov    %eax,0xb04
}
 ...
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	bf 08 0b 00 00       	mov    $0xb08,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 08 0b 00 00 08 	movl   $0xb08,0xb08
 806:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 80b:	c7 05 0c 0b 00 00 00 	movl   $0x0,0xb0c
 812:	00 00 00 
    if(p->s.size >= nunits){
