...
main(int argc, char *argv[])
{
  ...
  1b:	74 45                	je     62 <main+0x62>
        printf(1, "Error no param\n");
    }
    else if(argc >2){
  1d:	83 f8 02             	cmp    $0x2,%eax
  20:	7f 2d                	jg     4f <main+0x4f>
  ...
  31:	89 c3                	mov    %eax,%ebx
        printf(1, "Now sleep %d clock ticks\n", t);
  33:	68 c9 07 00 00       	push   $0x7c9
  38:	6a 01                	push   $0x1
  3a:	e8 01 04 00 00       	call   440 <printf>
        sleep(t);
  3f:	89 1c 24             	mov    %ebx,(%esp)
  42:	e8 2c 03 00 00       	call   373 <sleep>
  ...
  60:	eb e8                	jmp    4a <main+0x4a>
        printf(1, "Error no param\n");
  62:	52                   	push   %edx
  63:	52                   	push   %edx
  64:	68 a8 07 00 00       	push   $0x7a8
  69:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb e3 07 00 00       	mov    $0x7e3,%ebx
        while(*s != 0){
 ...
 636:	73 10                	jae    648 <free+0x38>
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 669:	5d                   	pop    %ebp
